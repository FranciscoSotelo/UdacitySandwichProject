...
public class DetailActivity extends AppCompatActivity {
    ...
    private void populateUI(Sandwich sandwich) {
        ...
        mAlsoKnownAsTextView.setText(buildStringFromList(sandwich.getAlsoKnownAs()));
        mIngredientsTextView.setText(buildStringFromList(sandwich.getIngredients()));
    }
